(function ($) {
	$.widget("ui.rcarousel", {
		...
		_goToPrevPage: function( by ) {
			...
			_dist = (options.width * _page.length + ( options.margin * _page.length )) + (options.border * options.visible) * 2; // added
		...
		_setCarouselHeight: function() {
			...
			if ( options.orientation === "vertical" ) {
				...
				_newHeight = options.height + (options.border * 2); // added
			}
		...
		_setCarouselWidth: function() {
			...
			if ( options.orientation === "horizontal" ) {
				_newWidth = (options.visible * options.width + options.margin * (options.visible - 1)) + (options.border * options.visible) * 2; // added
			} else {
